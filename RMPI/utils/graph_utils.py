...
def collate_dgl(samples):
    ...
    return (batched_en_graph_pos, batched_dis_graph_pos, r_labels_pos), g_labels_pos, (batched_en_graph_neg, batched_dis_graph_neg, r_labels_neg), g_labels_neg


def move_batch_to_device_dgl(batch, device):
    ((en_g_dgl_pos, dis_g_dgl_pos, r_labels_pos), targets_pos, (en_g_dgl_neg, dis_g_dgl_neg, r_labels_neg), targets_neg) = batch
    ...
    en_g_dgl_pos = send_graph_to_device(en_g_dgl_pos, device)
    en_g_dgl_neg = send_graph_to_device(en_g_dgl_neg, device)
    dis_g_dgl_pos = send_graph_to_device(dis_g_dgl_pos, device)
    dis_g_dgl_neg = send_graph_to_device(dis_g_dgl_neg, device)

    return ((en_g_dgl_pos, dis_g_dgl_pos, r_labels_pos), targets_pos, (en_g_dgl_neg, dis_g_dgl_neg, r_labels_neg), targets_neg)
