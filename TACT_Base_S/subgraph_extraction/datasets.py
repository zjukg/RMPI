...
def generate_subgraph_datasets(params, splits=['train', 'valid'], saved_relation2id=None, max_label_value=None):
    ...
    if not testing:
        ...
        # data_path2 = os.path.join(params.main_dir, f'../../data/{params.dataset}/rel_vectors.pkl')
        # if not os.path.isdir(data_path2) and not testing:
        #     with open(data_path2, 'wb') as f:
        #         pickle.dump(rel_vectors, f)
...
class SubgraphDataset(Dataset):
    ...
    def _prepare_subgraphs(self, nodes, r_label, n_labels):
        ...
        # print(type(subgraph.edata['type'][edges_btw_roots]))
